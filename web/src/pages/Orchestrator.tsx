...
import ConstellationView from './orchestrator/ConstellationView';
import TenantCreateModal from './orchestrator/TenantCreateModal';
...
export const STAGE_META: Record<TenantStage, { label: string; ordinal: number }> = {
...
export const CATEGORY_META: Record<TenantCategory, { label: string; tint: string }> = {
...
export const ACTIVITIES_META: Record<
  TenantActivity,
